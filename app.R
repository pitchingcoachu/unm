...
# ---- Notes API config ----
NOTES_API_URL   <- "https://script.google.com/macros/s/AKfycbyo6HKhHDSoUNRWtmFpto7BLqBxWU2nG5-ifkmsDTYqHq5mBFGhtdsmIGvb25xFsNh0/exec"
NOTES_API_TOKEN <- "unmbaseball"
            ...
            fluidRow(
              ...
              column(2,
                     div(style = "text-align: right; padding-top: 30px;",
                         tags$img(src = "UNMlogo.png", style = "height: 40px; max-width: 100%;")
                     )
              )
            ),
            hr(),
...
")),
  ...
  navbarPage(
    title = tagList(
      tags$img(src = "UNMlogo.png", class = "brand-logo", alt = "UNM"),
...
server <- function(input, output, session) {
  ...
  admin_emails <- c("jgaynor@pitchingcoachu.com", "mlopez41@unm.edu", "jstill@unm.edu")
